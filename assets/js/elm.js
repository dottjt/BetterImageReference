...
if (typeof _user$project$MainReferenceTool$main !== 'undefined') {
    _user$project$MainReferenceTool$main(Elm['MainReferenceTool'], 'MainReferenceTool', undefined);
}
Elm['MainSearch'] = Elm['MainSearch'] || {};
if (typeof _user$project$MainSearch$main !== 'undefined') {
    _user$project$MainSearch$main(Elm['MainSearch'], 'MainSearch', undefined);
}
