	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('reference tool peter pan'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$Search_Model$searchCollectionListDecoder = _elm_lang$core$Json_Decode$list(_user$project$Search_Model$searchCollectionDecoder);
var _user$project$Search_Model$Model = F3(
	function (a, b, c) {
		return {searchedCollections: a, searchInput: b, error: c};
	});

var _user$project$Search_Msg$FetchSearchCollectionListSuccess = function (a) {
	return {ctor: 'FetchSearchCollectionListSuccess', _0: a};
};
var _user$project$Search_Msg$FetchSearchCollectionListFail = function (a) {
	return {ctor: 'FetchSearchCollectionListFail', _0: a};
};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('hello there soldier'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$Search_Command$fetchSearchQuery = function (searchInput) {
	return A5(
		...
		_user$project$Search_Msg$FetchSearchCollectionListFail,
		_user$project$Search_Msg$FetchSearchCollectionListSuccess);
};
...
var _user$project$Search_Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'FetchSearchCollectionListSuccess':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
