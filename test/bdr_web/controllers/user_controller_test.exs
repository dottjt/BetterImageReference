defmodule BdrWeb.UserControllerTest do
  use BdrWeb.ConnCase

  alias Bdr.Account
  alias Bdr.Account.User

  @create_attrs %{display_name: "some display_name", email: "some email", name: "some name", password: "some password", tier: "some tier"}
